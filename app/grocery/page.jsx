...
const Grocery = () => {
    ...
    const subcategories = ['Fruits', 'Vegetables', 'Oil', 'Dal', 'Others'];

    return (
        <>
            <Navbar />
            {subcategories.map((subcategory, index) => {
                const subcategoryProducts = products.filter(product => product.category === "Grocery" && product.sub_category === subcategory);
